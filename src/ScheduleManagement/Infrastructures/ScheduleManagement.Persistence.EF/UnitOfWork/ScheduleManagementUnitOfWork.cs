...
{
    public class ScheduleManagementUnitOfWork : IScheduleManagementUnitOfWork
    {
        private readonly ScheduleManagementDbContext _context;
        private IDbContextTransaction _currentTransaction;
        private readonly IEventBus _eventBus;

        public ScheduleManagementUnitOfWork(ScheduleManagementDbContext context, IEventBus eventBus)
        {
            _context = context;
            _eventBus = eventBus;
        }
