...
namespace Framework.Exception.Exceptions
{
    public class AppException : System.Exception
    {
        ...
        public AppException(ResultCode resultCode, string message, System.Exception exception)
            : this(resultCode, message, HttpStatusCode.InternalServerError, exception)
        {
        }

        public AppException(ResultCode resultCode, string message, System.Exception exception, object additionalData)
            : this(resultCode, message, HttpStatusCode.InternalServerError, exception, additionalData)
        {
        }

        public AppException(ResultCode resultCode, string message, HttpStatusCode httpStatusCode, System.Exception exception)
            : this(resultCode, message, httpStatusCode, exception, null)
        {
        }

        public AppException(ResultCode resultCode, string message, HttpStatusCode httpStatusCode, System.Exception exception, object additionalData)
